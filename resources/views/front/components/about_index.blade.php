                ...
                <section>
                    <div class="row">
                            <div class="col-md-6 text-center">
                                ...
                                <img class="rounded float-right" style="width: 80%; height: 80%" src="{{asset(isset(page('about')->images[0]->url) ? page('about')->images[0]->url : asset('default.jpg'))}}" alt="">
                            </div>
                            <div class="col-md-6" >
                                <div class="title title-flex">
                                    <div >
                                        <h2>Our Vision</h2>
                                        <p class="text-justify">Leadership in the field of supplying integrated hotel equipment in the Sultanate of Oman
                                            ina way that is compatible with modern developments and superior service, and then
                                            elevating the hospitality industry in the Sultanate to the global level to be the optimal
                                            standard and the first, easiest and fastest choice for customers.</p>
                                    </div>
                                </div>
