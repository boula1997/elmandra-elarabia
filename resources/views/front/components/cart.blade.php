                                        ...
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                ...
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="product-left-thumbnail.html">{{ cartItem($item->getId())->title }}</a>
                                                        </li>
                                                        ...
                                                        <li class="text-content"><span
                                                                class="text-title">Quantity</span> {{ $item->get('quantity')  }}</li>

                                                        <li>
                                                            <h5 class="text-content d-inline-block">Price :</h5>
                                                            <span>$35.10</span>
                                                            <span class="text-content">{{ $item->get('price') }}</span>
                                                        </li>
                                                            ...
                                                            <div class="cart_qty">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control input-number qty-input"
                                                                        type="text" name="quantity" value="{{old('quantity',$item->get('quantity'))}}">
                                                ...
                                                <div class="cart_qty">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control input-number qty-input" type="text"
                                                            name="quantity" value="{{old('quantity',$item->get('quantity'))}}">
                                                        <button type="button" class="btn qty-right-plus"
                                                            data-type="plus" data-field="">
