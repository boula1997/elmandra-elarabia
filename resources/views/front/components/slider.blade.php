      ...
      <section class="home-section pt-2">
        <div class="container-fluid-lg">
            <div class="row g-4">
                <div class="col-xl-9 col-lg-8 float-right">
                    <div class="home-contain h-100">
                        ...
                        <div class="home-detail p-center-left w-75 position-relative mend-auto">
                            <div>
                                ...
                                <h1 class="w-100 text-uppercase poster-1">{{ page('slider')->title }} <span
                                        class="daily">{{ page('slider')->subtitle }}</span></h1>
                                <p class="w-100 d-none d-sm-block">{!! page('slider')->description !!}</p>
