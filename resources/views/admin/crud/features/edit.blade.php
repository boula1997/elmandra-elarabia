        ...
        @method('PUT')
            ...
            <div class="card card-custom mb-2">
                 <div class="card-header card-header-tabs-line">
                     @include('admin.components.breadcrumb', ['module' => 'features', 'action' => 'edit'])
                 </div>
                            ...
                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale . '[subtitle]' }}"
                                            ...
                                            value="{{ old($locale . '.subtitle', $feature->translate($locale)->subtitle) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-form-group">
                                    ...
                                    <textarea rows="100" class="summernote @error($locale . '.description') is-invalid @enderror"
                                        ...
                                        {!! old($locale . '.description', $feature->translate($locale)->description) !!} 
                                    </textarea>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="count" value="{{ old('count', $feature->count) }}"
