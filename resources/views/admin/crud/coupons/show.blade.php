                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-7 bg-light p-3 rounded h-100">
                                            <div class="card-title fw-bold">
                                                ...
                                                <p class="m-0">{{ $coupon->translate($locale)->title }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-7 bg-light p-3 rounded h-100">
                                            <div class="card-title fw-bold">
                                                ...
                                                <p class="m-0">{{ $coupon->translate($locale)->subtitle }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-7 bg-light p-3 rounded h-100">
                                            <div class="card-title fw-bold">
                                                ...
                                                <p class="m-0">{!!  $coupon->translate($locale)->description !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        @if ($coupon->file !== null)
                            ...
                            <br>
                            <img src="{{ asset($coupon->image) }}" class="w-50">
                        @endif
                    </div>
                </div>
