                            ...
                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale . '[title]' }}"
                                            ...
                                            value="{{ old($locale . '.title', $coupon->translate($locale)->title) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale . '[subtitle]' }}"
                                            ...
                                            value="{{ old($locale . '.subtitle', $coupon->translate($locale)->subtitle) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-form-group">
                                    ...
                                    <textarea rows="100" class="summernote @error($locale . '.description') is-invalid @enderror"
                                        ...
                                        {!! old($locale . '.description', $coupon->translate($locale)->description) !!} 
                                    </textarea>
                                </div>
                            </div>
                        @endforeach
