...
@section('form_action', route('units.update', $unit->id))
        ...
        @method('PUT')
            ...
            <div class="card card-custom mb-2">
                 <div class="card-header card-header-tabs-line">
                     @include('admin.components.breadcrumb', ['module' => 'units', 'action' => 'edit'])
                 </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale . '[title]' }}"
                                            ...
                                            value="{{ old($locale . '.title', $unit->translate($locale)->title) }}">
                                    </div>
                                </div>
