...
@section('form_action', route('benefits.update', $benefit->id))
        ...
        @method('PUT')
            ...
            <div class="card card-custom mb-2">
                <div class="card-header card-header-tabs-line">
                    @include('admin.components.breadcrumb', ['module' => 'benefits', 'action' => 'edit'])
                </div>
                            ...
                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale . '[title]' }}"
                                            ...
                                            value="{{ old($locale . '.title', $benefit->translate($locale)->title) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-form-group">
                                    ...
                                    <textarea rows="100" class="summernote @error($locale . '.description') is-invalid @enderror"
                                        ...
                                        {!! old($locale . '.description', $benefit->translate($locale)->description) !!} 
                                    </textarea>
                                </div>
                            </div>
                        @endforeach
            ...
            <div class="card card-custom">
                <div class="card-footer mb-5 mt-5">
                    ...
                    <a href="{{ route('benefits.index') }}" class="btn btn-outline-danger font-weight-bold">@lang('general.cancel')</a>
                </div>
            </div>
        </div>
    </div>
