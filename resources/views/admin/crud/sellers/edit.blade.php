...
@section('form_action', route('sellers.update', $seller->id))
        ...
        @method('PUT')
            ...
            <div class="card card-custom mb-2">
                 <div class="card-header card-header-tabs-line">
                     @include('admin.components.breadcrumb', ['module' => 'sellers', 'action' => 'edit'])
                 </div>
                            ...
                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale . '[title]' }}"
                                            ...
                                            value="{{ old($locale . '.title', $seller->translate($locale)->title) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale . '[subtitle]' }}"
                                            ...
                                            value="{{ old($locale . '.subtitle', $seller->translate($locale)->subtitle) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-form-group">
                                    ...
                                    <textarea rows="100" class="summernote @error($locale . '.description') is-invalid @enderror"
                                        ...
                                        {!! old($locale . '.description', $seller->translate($locale)->description) !!} 
                                    </textarea>
                                </div>
                                {{-- <div class="form-group">
                                        <label>@lang('sellers.description') - @lang('general.'.$locale)<span class="text-danger"> * </span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="count" value="{{ old('count', $seller->count) }}"
