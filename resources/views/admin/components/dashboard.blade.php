...
<div class="preloader flex-column justify-content-center align-items-center">
            <a href="{{ route('front.home') }}">
                <img class="animation__shake" width="300px" height="300px" src="{{ settings()->logo}}" alt="AdminLTELogo"
                    height="60" width="60">
            </a>
        </div>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            ...
                            <p>
                                ...
                                <i class=" px-1 fas fa-angle-left right"></i>
                                <span class="badge badge-info right">{{ itemsCount('advertisements') }}</span>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            ...
                            <p>
                                ...
                                <i class=" px-1 fas fa-angle-left right"></i>
                                <span class="badge badge-info right">{{ itemsCount('advantages') }}</span>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
